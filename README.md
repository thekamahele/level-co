...
·
When you're done, please send to jason.worry@capitalone.com a zipped directory containing your script, a README documenting how we should compile (if necessary) and run it, and the .git directory or equivalent. Also copy simy.rajan@capitalone.com
